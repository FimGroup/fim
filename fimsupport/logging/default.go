...
var loggerManager providers.LoggerManager = defaultLoggerManager{}

func SetLoggerManager(lm providers.LoggerManager) {
	if lm == nil {
...
func GetLoggerManager() providers.LoggerManager {
...
func (d defaultLoggerManager) GetLogger(loggerName string) providers.Logger {
